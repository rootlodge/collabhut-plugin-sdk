 ...
 * ```
 */
export type AudioEffectFactory<
    TParams extends ReadonlyArray<PluginParam> = ReadonlyArray<PluginParam>
> = (
...
export interface AudioEffectModule {
    readonly manifest: PluginManifest & { readonly type: "audio-effect" }
