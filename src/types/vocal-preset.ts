...
export interface VocalCompressorSettings {
    readonly enabled: boolean
    readonly threshold: number   // dB, -60 to 0
    readonly knee: number        // dB, 0 to 40
    readonly ratio: number       // 1:1 to 20:1
...
export interface VocalDeEsserSettings {
    readonly enabled: boolean
    readonly frequency: number   // Hz, center of sibilance band
    readonly threshold: number   // dB
    readonly range: number       // dB of reduction
}
...
export interface VocalSaturationSettings {
    ...
    readonly mix: number    // 0–1, dry/wet blend
}
...
export interface VocalReverbSettings {
    ...
    readonly preDelay: number  // seconds
    readonly mix: number       // 0–1
}
...
export interface VocalDelaySettings {
    readonly enabled: boolean
    readonly time: number       // seconds per beat division
    readonly feedback: number   // 0–1
    readonly filter: number     // Hz, low-pass on repeats
    readonly mix: number        // 0–1
}
...
export interface VocalPresetModule {
    readonly manifest: PluginManifest & { readonly type: "vocal-preset" }
